      ...
      <div className="w-full pb-11 md:pb-5 bg-white-A700 shadow-sm">
        <div>
          <Img
            ...
            alt="imageeight_one"
            className="w-[150px] ml-[150px] z-[1] object-cover"
          />
          <div className="flex flex-row md:flex-col">
            <div
              className="order-2 md:order-1 p-4 m-2 text-white w-[46%]"
              style={{
                alignSelf: "center",
              }}
            >
              ...
              >
                <Heading size="2xl" as="h1" className="!text-teal-900_03">
                  CareClean
                </Heading>
                <Text
                  size="2xl"
            ...
            <div
              className="order-1 md:order-2  p-4 m-2 text-white"
              style={{ width: "419px" }}
            >
              <div className="flex flex-col items-center">
                <Img
                  ...
                  alt="imageone_one"
                  className="self-stretch h-[359px]  object-cover rounded-[12px]"
                />
            ...
            <div
              className="order-3   p-4 m-2 text-white"
              style={{ width: "419px" }}
            >
              <div className="flex flex-col items-center">
                <Img
            ...
            {/* <div className="order-3   p-4 m-2 text-white">
              <div className="flex flex-col items-center">
                <Img
                  src="images/img_rectangle_4.png"
                  alt="image_two"
                  className="h-[359px] w-[25%] right-0 m-auto object-cover absolute"
                />
                <div className="flex flex-col items-center w-[27%] right-0  m-auto absolute">
                  <Img
                    src="images/img_image_383x383.png"
                    alt="image_four"
          ...
          <div className="flex flex-col items-end ">
            <div className="self-stretch w-full mx-auto md:p-5 max-w-[1462px]">
              <div className="mt-2">
                ...
                <div className="h-[493px] mt-[-4px] relative">
                  <div className="flex flex-col justify-center w-full   absolute">
                    <div className="flex   bg-white-A700">
                      {/* <div className="flex flex-col items-end w-[77%] mt-[85px]">
                        <div className="flex md:flex-col self-stretch justify-between items-start mr-[183px] gap-5">
                          <div className="w-[41%] md:w-full"></div>
                        </div>
                        ...
                        <div className="flex md:flex-col justify-between items-start w-[74%] md:w-full gap-5">
                          <div className="flex justify-between items-start w-[46%] md:w-full gap-5">
                            ...
                            >
                              ...
                              to bring peace, health, and joy to our community.
                            </Text>
                          </div>
                      ...
                      >
                        <div
                          className="order-1 md:order-1 p-4 m-2 text-white "
                          style={{
                            alignSelf: "center",
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              className="flex self-end justify-center items-start mt-[3px] gap-[21px] w-[80%]"
                              style={{
                                marginLeft: "10px",
                              }}
                            >
                        ...
                        <div
                          className="order-2 md:order-1 p-4 m-2 text-white "
                          style={{
                            flex: 1,
                          }}
                        >
            ...
            <div className="flex md:flex-col items-center w-[93%] mt-14 ml-[21px] gap-11">
              ...
              <div className="flex flex-col items-center flex-1">
                <form
                  ...
                  className="flex flex-col self-stretch justify-center gap-[3px]"
                >
